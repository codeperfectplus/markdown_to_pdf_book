...
__title__ = 'Markdown to Book'
__package_name__ = 'md2book'
__version__ = '0.0.1'
__description__ = "Python Module To Convert Markdown Files to Book"
__email__ = "deepak008@live.com"
__author__ = 'Deepak Raj'
__github__ = 'https://github.com/'
__pypi__ = 'https://pypi.org/project/md2book/'
...
setuptools.setup(
    ...
    data_files=[('assets', glob('md2book/assets/*'))],
    url=__github__,
    ...
    classifiers=[
        ...
        "Environment :: Plugins"],
    entry_points={
        "console_scripts": ['md2book = md2book.cli:main']
